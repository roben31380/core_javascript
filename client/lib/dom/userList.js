...
function createSpinner(size = 100, loadingMessage = '로딩중') {
  ...
  >
    <defs>
      <mask id="ldio-kf7lhs2b4on-mask">
        <path
          d="M50 13L75 30L75 70L50 87L25 70L25 30L50 13Z"
          fill="#fff"
          stroke="#000"
          stroke-width="0"
        ></path>
    ...
    ></path>
    <path
      d="M50 13L75 30L75 70L50 87L58.3 70L58.3 30Z"
      mask="url(#ldio-kf7lhs2b4on-mask)"
      fill="#ea4c89"
      stroke="#c32361"
      stroke-width="0"
    >
...
function createEmptyCard(size = 200, errorMessage = 'error') {
  return /*html*/ `<figure class="empty-user-card">
